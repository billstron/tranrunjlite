...
set lmargin 12
set ylabel 'Actuation, volts'
plot file using 1:6 title "Actuation, volts" with lines

set lmargin 12
set ylabel 'Velocity (rpm)'
plot file using 1:5 title "Velocity, rpm" with lines


set ylabel 'Position (rev)'
set key bottom
set lmargin 12
plot file using 1:4 title "Position, rev" with lines,\
